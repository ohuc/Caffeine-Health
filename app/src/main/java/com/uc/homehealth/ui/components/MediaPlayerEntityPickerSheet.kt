...
@Composable
fun MediaPlayerEntityPickerSheet(
    visible: Boolean,
    ...
    val pool = remember(allEntities, existingIds) {
        allEntities.filter { it.domain == "media_player" && it.entityId !in existingIds }
    }
...
@Composable
private fun MediaPlayerEntityRow(
